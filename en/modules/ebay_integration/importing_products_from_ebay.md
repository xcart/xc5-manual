...
2.  Specify which orders you want to import by adjusting the following fields:
    ...
    * **eBay Item SKU**: Enter the eBay SKU of the item that needs to be imported (Such a SKU can be obtained from the _Custom Label_ field). If you need to import multiple items, enter a comma separated list of SKUs.
    * **Upload item images**: 
