...
As to **XML sitemap**, it is a file that does exactly the opposite of robots.txt: it informs search engines about the URLs on your store website that are available for crawling. 
