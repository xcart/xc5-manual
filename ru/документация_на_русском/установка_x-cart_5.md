...
16.  время работы PHP скриптов должно быть {% link "правильно настроено" ref_aXNMLvFK %};
17.  такие компоненты как modRewrite должны быть включены, чтобы {% link "правильно работали ЧПУ" ref_dVnyA6vn %}.
...
**![]({{site.baseurl}}/attachments/7505579/8719628.png?effects=drop-shadow)
**
