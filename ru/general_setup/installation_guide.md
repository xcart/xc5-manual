...
X-Cart готов к работе. Начать лучше с заполнения {% link 'каталога товаров' ref_REno3u9g %}, настройки {% link 'способов оплаты' ref_guGkzxGn %} и {% link 'доставки' ref_Jq6Bsdrt %}. 
