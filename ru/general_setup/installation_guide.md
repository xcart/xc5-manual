 ...
 *   [Возможные проблемы с установкой](#section-13)
     ...
     *   [3. Отключенные функции](#section-15)
...
P.S. Помните и о {% link 'безопасности' ref_secureconfig %} магазина.
...
* Другие MySQL ошибки, которые говорят о проблеме с настройками MySQL сервера. Перешлите такие сообщения об ошибках своему хостинг провайдеру для решения проблемЖ
...
Статья о настройке {% link "libCurl" ref_sshnMtN7 %} будет полезна, если вы устанавливаете X-Cart на локальном сервере.
